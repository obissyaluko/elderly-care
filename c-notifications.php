...
<div class="container my-5">
    ...
    <div class="notification">
        ...
        <p><?=$row['first_name']." ".$row['last_name']?> <?=$row['purpose']?>. 
        
        <?php if($row['notification_type'] == "message"){
            ?>
           Go to <a href="chat.php?userId=<?=$elder_user_id?>&receiverId=<?=$row['receiver_id']?>">Chat</a> </p>
           <?php
        }
        else{
            ?>
            Go to <a href="carer-schedule-meeting.php">Meeting</a> </p>
            <?php
        }
        ?>
